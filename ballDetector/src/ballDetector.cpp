...
#include <ballDetector/ballDebug.h>
#include <ballDetector/debugTimes.h>
#include <ballDetector/ballVisible.h>
...
private:
        ...
        //Publisher for ball visible
        ros::Publisher ball_vis_publisher_;
        ...
        //For debugging
        void debugCallBack(const ballDetector::ballDebug::ConstPtr& debug);
        ros::Subscriber debug_sub_;
        ballDetector::ballDebug debugLevel;
        ...
        ballDetector::debugTimes debugTimes;
        ...
        :it(nh)
{
        ...
        ball_vis_publisher_= nh.advertise<ballDetector::ballVisible>("ballVisible",1)
;
#ifdef BALLDETECTOR_DEBUG
        ...
        debug_sub_ = nh.subscribe<ballDetector::ballDebug>("balldebug/level", 1, &BallDetector::debugCallBack, this);
        //Debug defaults
        ...
        //Debug time pub
        debugTime_pub_ = nh.advertise<ballDetector::debugTimes>("balldebug/times",1);
...
#ifdef BALLDETECTOR_DEBUG
void BallDetector::debugCallBack(const ballDetector::ballDebug::ConstPtr& debug){
        debugLevel = *debug;
